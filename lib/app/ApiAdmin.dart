...
class ApiAdmin extends AppConstants {
  ...
  Future<Response<Map>> changeOrderStatus(var id, var status,comment) async {
    Map params = Map<String, dynamic>();
    params['updateBookingId'] = id;
    params['orderStatus'] = status;
    params['commentvalue'] = comment;
    return await getInstance()
        .post('changeEcommerceOrderStatus', data: params);
  }
  Future<Response<Map>> getSalesOrder(String value) async {
    Map params = Map<String, dynamic>();
  ...
  Future<Response<Map>> getLinkUserList() async {
    ...
    params['konnect_id'] = konnectId;
    params['user_id'] = userId;
    return await getInstance().post('getLinkUserList', data: params);
  }
  ...
  Future<Response<Map>> getLedgerThrewGst(String id) async {
    return await getInstance().post('getLedgerThrewGst', data: {'booking_id': id});
  }
