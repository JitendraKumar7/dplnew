...
import 'package:dpl/Pdfview/SalesInvoicerpdf.dart';

import '../base/libraryExport.dart';

class SalesInvoiceThrewInvoiceNo extends StatefulWidget {
  final Map id;

  const SalesInvoiceThrewInvoiceNo({Key key, this.id}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _SalesInvoiceThrewInvoiceNoState();
}

class _SalesInvoiceThrewInvoiceNoState extends State<SalesInvoiceThrewInvoiceNo> {
  ...
  void initState() {
    ...
    ApiAdmin().getSalesInvoiceThrewInvoiceNo(widget.id['Invoiceno'],widget.id['gstno']).then((value) => {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    Bank bankValue=konnectDetails.bank[0];

    print('aaaaaaa${bankValue.accNo } ${bankValue.newBranch}');
    setState(() {
      String note =  'konnect';
    ...
    return Scaffold(
      ...
      appBar: AppBar( actions: [IconButton(icon: Icon(Icons.picture_as_pdf), onPressed: (){reportSalesInvoice(context, result,basicInfo,bankValue,location);})],
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              getRowDesign('GST No :- ' + location.gstNo, 15),
                              getRowDesign(
