...
import 'package:dpl/Pdfview/PurchaseInvoice.dart';

import '../base/libraryExport.dart';

class PurchaseInvoiceThrewInvoiceNoViewScreen extends StatefulWidget {
  final  id;

  const PurchaseInvoiceThrewInvoiceNoViewScreen({Key key, this.id}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _PurchaseInvoiceThrewInvoiceNoViewState();
}

class _PurchaseInvoiceThrewInvoiceNoViewState extends State<PurchaseInvoiceThrewInvoiceNoViewScreen> {
  ...
  void initState() {
    ...
    ApiAdmin().getPurchaseInvoiceThrewInvoiceNo(widget.id['Invoiceno'],widget.id['gstno']).then((value) => {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar( actions: [IconButton(icon: Icon(Icons.picture_as_pdf), onPressed: (){reportPurchaseInvoice(context, result,basicInfo,location);})],
