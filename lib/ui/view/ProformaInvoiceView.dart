...
import 'package:dpl/Pdfview/Performainvoice.dart';
...
class ProformaInvoiceViewScreen extends StatefulWidget {
  ...
  const ProformaInvoiceViewScreen({Key key, this.id}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _ProformaInvoiceViewState();
}

class _ProformaInvoiceViewState extends State<ProformaInvoiceViewScreen> {
  ...
  void initState() {
    ...
    ApiAdmin().getProformaInvoiceById(widget.id).then((value) => {
          setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar( actions: [IconButton(icon: Icon(Icons.picture_as_pdf), onPressed: (){reportPerformaInvoice(context, result,basicInfo,bankValue,location);})],
