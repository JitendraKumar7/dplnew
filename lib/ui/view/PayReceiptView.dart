...
import 'package:dpl/Pdfview/PaymentReceiptpdf.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [IconButton(icon: Icon(Icons.picture_as_pdf), onPressed: (){reportViewpayrecipt(context, basicInfo,result,location);})],
